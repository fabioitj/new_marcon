...
function FirstPage(){
    return (
        <section className="flex flex-col items-start justify-end bg-gray-200 h-[100vh] p-4 pb-32">
            ...
            <button className="bg-gray-800 hover:bg-gray-300 text-white hover:text-gray-800 font-bold py-3 px-6 inline-flex items-center text-2xl">CALL TO ACTION</button>
        </section>
    )
}
